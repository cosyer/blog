...
## xterm.js默认展示1000行
- https://github.com/xtermjs/xterm.js/issues/3198

## 名词解释(渗透测试、肉鸡、纵深防御、TP99、EMR、JupyterLab、S3)
渗透测试：模拟网络黑客的攻击对计算机系统安全进行评估测试从而发现系统的安全漏洞

肉鸡：也叫傀儡机，指被网络黑客远程控制的机器

纵深防御：也叫城堡方法，指在计算机系统安全上实现多层的安全控制策略，在黑客突破一层时还有其他的安全策略来防止受到入侵威胁从而降低攻击者成功的几
率

物理安全(服务器锁、安保) => 网络安全(防火墙) => 主机安全(用户安全、文件系统) => 应用安全(web应用防护加固) => 数据安全(数据加密)
...
S3: 对象存储服务(Simple Storage Service)
...
## 风控要略
互联网安全分为基础安全和业务安全
1. 注册登录场景：机器人注册账号、刷单、点赞关注等
2. 营销活动：发放的红包优惠券被薅羊毛
3. 广告营销：机器人点击
4. 爬虫：数据被扒

字符验证码=>识图验证码=>计算验证码=>轨迹验证码
...
## ?? 空值合并运算符
- 空值合并运算符，可以做到只把 null 和 undefined 替换为一个预定义的值
node: cjs/esm
web: esm/umd
